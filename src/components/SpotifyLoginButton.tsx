...
// Shows beta request modal when not signed in

import { spotifyAuth } from '@/services/spotifyAuth';
import { useState, useEffect } from 'react';
import { SpotifyBetaRequestModal } from './SpotifyBetaRequestModal';
...
export function SpotifyLoginButton() {
  ...
  // If not logged in, show login button that opens beta modal
  return (
    <>
      <button
        ...
        title="Request Spotify beta access or sign in"
      >
        {/* Spotify logo SVG */}
        <svg
          xmlns="http://www.w3.org/2000/svg"
